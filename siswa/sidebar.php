...
.gambar {
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <div class="sidebar-brand-icon rotate-n-15">
        ...
        <img class="gambar" src="logo.png" alt="">
      ...
      <li class="nav-item">
      	<a href="<?= base_url('siswa/dashboard.php') ?>" class="nav-link">
      		<i class="fas fa-fw fa-users"></i>
      		<span>Data Siswa</span>
      	</a>
      </li>
      <li class="nav-item">
        <a href="<?= base_url('inventori/inventori.php') ?>" class="nav-link">
          <i class="fas fa-fw fa-box"></i>
          <span>Data Inventori</span>
        </a>
      </li>
      <li class="nav-item">
        <a href="<?= base_url('mapel/mapel.php') ?>" class="nav-link">
          <i class="fas fa-fw fa-book-open"></i>
          <span>Mata Pelajaran</span>
        </a>
      </li>
      <li class="nav-item">
        <a href="<?= base_url('akun/akun.php') ?>" class="nav-link">
